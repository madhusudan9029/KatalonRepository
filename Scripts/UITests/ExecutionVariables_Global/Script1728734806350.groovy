...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_username'), GlobalVariable.UNAME)

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Password_password'), GlobalVariable.PASS)
